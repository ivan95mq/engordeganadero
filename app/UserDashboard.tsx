    ...
    useEffect(() => {
        ...
        if (userIdNumber) {
            const fetchUser = async () => {
                try {
                    const response = await axios.get(`https://jsonplaceholder.typicode.com/users/${userIdNumber}`);
    ...
    return (
        <View style={styles.container}>
            ...
            <View style={styles.profileContainer}>
                ...
                <Text style={styles.profileName}>{user?.name || 'Nombre no disponible'}</Text>

            </View>
            <View style={styles.menuContainer}>
                <TouchableOpacity style={styles.menuItem} onPress={() => console.log('Información Personal')}>
                    <Text style={styles.menuText}>Información Personal</Text>
                </TouchableOpacity>
                <TouchableOpacity style={styles.menuItem} onPress={() => console.log('Resultado del test')}>
                    <Text style={styles.menuText}>Resultado del test</Text>
                </TouchableOpacity>
                <TouchableOpacity style={styles.menuItem} onPress={() => console.log('Idiomas')}>
