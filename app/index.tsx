...
const HomeScreen = () => {
    ...
    return (
        <ImageBackground source={require('../assets/images/gallina.jpg')} style={styles.backgroundImage}>
            <View style={styles.container}>
                <Image source={require('../assets/images/meatverde.png')} style={styles.title} />
                ...
                <Image source={require('../assets/images/european.png')} style={styles.euImage} />
            </View>
        </ImageBackground>
    );
};
