    ...
    <View style={styles.container}>
      ...
      <View style={styles.adviceContainer}>
        ...
        >
          ...
          <AntDesign
            name={expandedSections["section1"] ? "up" : "down"}
            size={16}
            color="black"
          />
        </TouchableOpacity>
        {expandedSections["section1"] && (
          <Text style={styles.sectionContent}>
            Una denominación de origen protegida certifica la calidad y
            características de los productos vinculados al medio de producción.
          </Text>
        )}
        ...
        >
          ...
          <AntDesign
            name={expandedSections["section2"] ? "up" : "down"}
            size={16}
            color="black"
          />
        </TouchableOpacity>
        {expandedSections["section2"] && (
          <Text style={styles.sectionContent}>
            La certificación de la huella de carbono garantiza la reducción de
            emisiones a través de prácticas sostenibles.
          </Text>
        )}
        ...
        >
          <Text style={styles.sectionHeaderText}>
            3. Razas de crecimiento lento.
          </Text>
          <AntDesign
            name={expandedSections["section3"] ? "up" : "down"}
            size={16}
            color="black"
          />
        </TouchableOpacity>
        {expandedSections["section3"] && (
          <Text style={styles.sectionContent}>
            Las razas de crecimiento lento promueven el bienestar animal y una
