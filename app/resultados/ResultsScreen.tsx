...
const ResultsScreen = () => {
    ...
    return (
        <View style={styles.container}>
            ...
            <TouchableOpacity style={styles.modifyButton} onPress={() => router.push('../encuesta/EncuestaScreen')}>
                <Text style={styles.modifyButtonText}>Modificar Respuestas</Text>
            </TouchableOpacity>

            <TouchableOpacity onPress={() => console.log('Mostrar consejos para mejorar')}>
